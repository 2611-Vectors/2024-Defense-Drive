...
public class RobotContainer {
  ...
  private final Telemetry logger =
      new Telemetry(1.0 * TunerConstants.kSpeedAt12Volts.in(MetersPerSecond));
  ...
  /**
   * Read the current MaxSpeed from NetworkTables. Advantage Scope or any NetworkTables client can
