...
public class Shooter extends SubsystemBase {
  ...
  SparkMax bottomShooter =
      new SparkMax(Constants.ShooterConstants.BOTTOM_SHOOTER, SparkFlex.MotorType.kBrushless);
  SparkMax topShooter =
      new SparkMax(Constants.ShooterConstants.TOP_SHOOTER, SparkFlex.MotorType.kBrushless);
  ...
  //
  //   public void configurePID(SparkClosedLoopController motorPID, double p, double i, double d,
  // double ff) {
  //     motorPID.setP(p);
  //     motorPID.setI(i);
  //     motorPID.setD(d);
  ...
  //   }
  //
  //   public void configureShooterPID(SparkClosedLoopController motorPID, PIDFF_CONSTANTS
  // shooterConstants) {
