...
public class Intake extends SubsystemBase { 
    ...
    SparkMax loadingDrum = new SparkMax(Constants.IntakeConstants.LOADING_DRUM, SparkMax.MotorType.kBrushless);
    SparkMax leftHotwheel = new SparkMax(Constants.IntakeConstants.LEFT_HOTWHEEL, SparkMax.MotorType.kBrushless);
    SparkMax rightHotwheel = new SparkMax(Constants.IntakeConstants.RIGHT_HOTWHEEL, SparkMax.MotorType.kBrushless);
    SparkFlex groundPickup = new SparkFlex(Constants.IntakeConstants.GROUND_PICKUP, SparkFlex.MotorType.kBrushless);
    ...
    public Intake() {
        ...
        loadingDrum.configure(drumConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
    }
